...
public class LocationController {
    ...
    public ResponseEntity<Void> addLocation(
        ...
        long createdLocationId = locationService.createLocation(newLocation.getTitle(),newLocation.getDescription(), userDetails.getUserId()).getId();
    ...
    public ResponseEntity<Void> deleteLocation(
        ...
        locationService.deleteLocatiion(locationId, userDetails.getUserId());
