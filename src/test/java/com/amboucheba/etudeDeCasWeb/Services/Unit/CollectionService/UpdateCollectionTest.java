...
public class UpdateCollectionTest {
    ...
    public void collectionDoesNotExist__throwNotFoundException(){
        ...
        assertThrows(NotFoundException.class, () -> {
            collectionService.updateCollection(null, collectionId, null);
        });
    }
    ...
    public void collectionExist_userIdCorrect__throwNotFoundException(){
        ...
        Collection updatedCollection = new Collection(newTag, owner);
        ...
        Mockito.when(collectionRepository.save(updatedCollection)).thenReturn(updatedCollection);

        CollectionInput newCollection = new CollectionInput(newTag);

        Collection returned = collectionService.updateCollection(newCollection, collectionId, userId);

        assertEquals(newTag, returned.getTag());
        assertEquals(collectionId, returned.getId());
    }
}
